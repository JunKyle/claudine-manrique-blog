              ...
              return (
                <div key={i} className="PortefolioDeveloppeuse__item">
                  ...
                  <div className="PortefolioDeveloppeuse__content">
                    ...
                    {post.github ?
                      (<Link className="PortefolioDeveloppeuse__link" target='_blank' href={post.github}><Image alt="github icone" src="/images/github.png" width="15" height="15"/><span>GitHub</span></Link>) : ""
                    }
                    {post.url ?
                      (<Link className="PortefolioDeveloppeuse__link" target='_blank' href={post.url}><Image alt="link icone" src="/images/link.png" width="15" height="15"/><span>site en ligne</span></Link>) : ""
                    }
                  </div>
                </div>
              );
